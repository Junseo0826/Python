...
for i in range(5):
    fruits.append(input((str(i+1))+". 좋아하는 과일의 이름을 입력하시오 : "))   # 입력받은 변수의 값을 리스트에 추가

print("입력한 과일 리스트 : ",fruits)

# 찾기
find_fruits = input("좋아하는 과일 하나를 입력하세요 : ")

# 사용자가 입력한 과일이 리스트에 있는지 판단.
# 있으면 => 00은 당신이 좋아하는 과일입니다.
# 없으면 => 00은 당신이 좋아하는 과일이 아닙니다.
if find_fruits in fruits:
    print(f"{find_fruits}은(는) 당신이 좋아하는 과일입니다.")
else :
    print(f"{find_fruits}은(는) 당신이 좋아하는 과일이 아닙니다.")