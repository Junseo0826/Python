...
phone_book1['이준서'] = '010-9632-7009'

print("phone_book1 :", phone_book1) # {'이준서' : '010-9632-7009'}

# 딕셔너리에 값 저장. 2. {key : value}
phone_book2 = {'홍길동' : '010-7899-4545', '이준서' : '010-9632-7009'}
print("phone_book2 :", phone_book2)

phone_book3 = {}
phone_book3['이준서'] = '010-9632-7009'
phone_book3['가나다'] = '010-9142-1259'
phone_book3['라마바'] = '010-7124-7459'
phone_book3['사아자'] = '010-1699-1294'
phone_book3['차카타'] = '010-3715-8012'
...
print("딕셔너리 작성 시 :(콜론)을 기주능로 key:value 작성")
person_dict = {'name' : '이준서', 'age' : 19, 'class' : '1학년'}

print("name :",person_dict['name'])     # 딕셔너리에 'name' 키로 값을 조회하여 출력
print("age :",person_dict['age'])       # 딕셔너리에 'age' 키로 값을 조회하여 출력
